...
public class LmsDbContext : DbContext
{
    ...
    public DbSet<MadCloudTask> MadCloudTasks => Set<MadCloudTask>();
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<MadCloudTask>(e => {
            e.ToTable("MadCloudTasks", "dbo");
            e.Property(t => t.TaskType).HasMaxLength(80);
            e.Property(t => t.Status).HasMaxLength(40);
        });
    }
}
