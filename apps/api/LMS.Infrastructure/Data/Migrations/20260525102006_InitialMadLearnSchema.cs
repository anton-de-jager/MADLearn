...
{
    /// <inheritdoc />
    public partial class InitialMadLearnSchema : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TaskType = table.Column<string>(type: "nvarchar(80)", maxLength: 80, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MadCloudTasks", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MadCloudTasks_Users_UserId",
                        column: x => x.UserId,
                        principalSchema: "dbo",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CodeExample = table.Column<string>(type: "nvarchar(max)", nullable: true),
