      ...
      @if (summary) {
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          <div class="stat-card text-center">
            <p class="text-4xl font-black text-blue-600">{{ summary.completedLessons }}</p>
            ...
            @if (progresses.length === 0) {
              <div class="text-center py-12 text-gray-400">
                ...
                <a routerLink="/dashboard">
                  <button class="mt-4 px-6 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700">Browse Courses</button>
                </a>
              </div>
            }
          </div>
